...
public class BirtEnvironment {
	...
	public IReportEngine getReportEngine() throws IOException, BirtException {
		...
		final File loggingProperties = new File("./logging.properties");
	...
	/*
	 * The engine needs to see a list of each jar file concatenated as a string using the standard file system separator to divide the files
	 */
